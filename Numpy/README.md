...
این فایل README یک مرور جامع از نوت‌بوک Jupyter نوشته‌شده با استفاده از کتابخانه NumPy ارائه می‌دهد. تمام بخش‌ها با توضیحات کامل و خروجی‌های مربوطه آورده شده‌اند.

## فهرست مطالب
1. [ساخت آرایه ساده NumPy](#1-ساخت-آرایه-ساده-numpy)
2. [تغییر شکل آرایه](#2-تغییر-شکل-آرایه)
3. [آرایه‌های چندبعدی و فیلتر شرطی](#3-آرایه‌های-چندبعدی-و-فیلتر-شرطی)
4. [آرایه‌های مختلط](#4-آرایه‌های-مختلط)
5. [آرایه‌های صفر و یک](#5-آرایه‌های-صفر-و-یک)
6. [تابع linspace و full](#6-تابع-linspace-و-full)
7. [آرایه‌های تصادفی](#7-آرایه‌های-تصادفی)
8. [تخت‌سازی آرایه](#8-تخت‌سازی-آرایه)
9. [عملیات ریاضی ساده](#9-عملیات-ریاضی-ساده)
10. [آمار ساده](#10-آمار-ساده)
11. [عملیات ماتریسی](#11-عملیات-ماتریسی)
12. [ترسیم با matplotlib](#12-ترسیم-با-matplotlib)
13. [مرتب‌سازی و اندیس‌گذاری](#13-مرتب‌سازی-و-اندیس‌گذاری)
14. [برش آرایه‌ها](#14-برش-آرایه‌ها)
15. [اندیس‌گذاری چندبعدی](#15-اندیس‌گذاری-چندبعدی)
16. [اتصال آرایه‌ها](#16-اتصال-آرایه‌ها)
17. [تقسیم آرایه‌ها](#17-تقسیم-آرایه‌ها)
18. [کپی کردن آرایه](#18-کپی-کردن-آرایه)
19. [پر کردن آرایه](#19-پر-کردن-آرایه)
20. [کار با تاریخ‌ها](#20-کار-با-تاریخ‌ها)
21. [عملیات بولی و فیلتر](#21-عملیات-بولی-و-فیلتر)
22. [توابع ریاضی پیشرفته](#22-توابع-ریاضی-پیشرفته)
23. [ذخیره‌سازی و خواندن فایل‌ها](#23-ذخیره‌سازی-و-خواندن-فایل‌ها)
24. [تولید داده‌های تصادفی](#24-تولید-داده‌های-تصادفی)
25. [مرتب‌سازی و argsort](#25-مرتب‌سازی-و-argsort)
26. [ماسک‌گذاری پیشرفته](#26-ماسک‌گذاری-پیشرفته)
27. [تابع دلخواه روی آرایه](#27-تابع-دلخواه-روی-آرایه)
28. [بردارسازی الگوریتم‌ها](#28-بردارسازی-الگوریتم‌ها)
29. [شرط‌های برداری](#29-شرط‌های-برداری)
30. [گرادیان ساده](#30-گرادیان-ساده)

## 1. ساخت آرایه ساده NumPy
```python
import numpy as np
